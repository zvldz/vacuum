...
LIST_CUSTOM_PRINT_USAGE+=("custom_print_usage_x_custom_dropbear")
LIST_CUSTOM_PRINT_HELP+=("custom_print_help_x_custom_dropbear")
LIST_CUSTOM_PARSE_ARGS+=("custom_parse_args_x_custom_dropbear")
LIST_CUSTOM_FUNCTION+=("custom_function_x_custom_dropbear")
ENABLE_CUSTOM_DROPBEAR=${ENABLE_CUSTOM_DROPBEAR:-"0"}

function custom_print_usage_custom_dropbear() {
    cat << EOF
...
function custom_print_help_x_custom_dropbear() {
    cat << EOF
...
function custom_parse_args_x_custom_dropbear() {
    case ${PARAM} in
        *-custom-dropbear)
...
function custom_function_x_custom_dropbear() {
