...
LIST_CUSTOM_PRINT_USAGE+=("custom_print_usage_01_history")
LIST_CUSTOM_PRINT_HELP+=("custom_print_help_01_history")
LIST_CUSTOM_PARSE_ARGS+=("custom_parse_args_01_history")
LIST_CUSTOM_FUNCTION+=("custom_function_01_history")
ENABLE_HISTORY=${ENABLE_HISTORY:-"0"}

function custom_print_usage_01_history() {
    cat << EOF
...
function custom_print_help_01_history() {
    cat << EOF
...
function custom_parse_args_01_history() {
    case ${PARAM} in
        *-enable-history)
            ENABLE_HISTORY=1
            ;;
...
function custom_function_01_history() {
